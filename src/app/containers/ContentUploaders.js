...
class User extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <Newadd data={{title:"Add Content Uploader",role:"2"}}/>
                    <div className="row" id="title">
                        <div className="col-sm-10" id="userslist">Content Uploaders</div>
                        <div className="col-sm-2" >
                            <button type="button" className="btn btn-info btn-sm" data-toggle="modal"
                                    data-target="#myUserAddModal">
                                <span className="glyphicon glyphicon-plus"/> Add Content Uploader
                            </button>
                        </div>
                    </div>

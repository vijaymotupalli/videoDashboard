...
import {editVideo,setSelectedVideo} from "../actions/index";
...
class EditVideo extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            subject: this.props.selectedVideo.subject ? this.props.selectedVideo.subject:"",
            standard: this.props.selectedVideo.standard ? this.props.selectedVideo.standard:"",
    ...
    componentWillReceiveProps(nextProps){
        this.setState ({
            ...
            subject: nextProps.selectedVideo.subject ? nextProps.selectedVideo.subject:"",
            standard: nextProps.selectedVideo.standard ? nextProps.selectedVideo.standard:"",
